...
# Read planets.csv to database, please put the .csv file in the same directory of this .py file
...
# Read species.csv to database, please put the .csv file in the same directory of this .py file
...
while(flag):
    ...
    if selection.isdigit() and -1 < int(selection) < 6: # Solve if user inputs anything else than desired values.
        ...
        if selection == 1:
            query = '''SELECT name FROM planets WHERE name != "NA" '''
